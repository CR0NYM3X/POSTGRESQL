...
# ------------------------------------------------------------------------------------------------------------------------------------------------------------
# ------------------------------------------------------------ POWERSHELL LEVANTAR SERVER   ----------------------------------------------------------------
# ------------------------------------------------------------------------------------------------------------------------------------------------------------

$argumentos = '/c set "PATH=%PATH%;C:\Users\%USERNAME%\AppData\Local\Programs\pgAdmin 4\runtime" && "C:\Users\%USERNAME%\AppData\Local\Programs\pgAdmin 4\python\python.exe" "C:\Users\%USERNAME%\AppData\Local\Programs\pgAdmin 4\web\pgAdmin4.py"'
